...
def register_new_usr(name_sign_up: str, email_sign_up: str, username_sign_up: str, role1: str, phone_sign_up:str, address_sign_up:str, gender_sign_up:str, age_sign_up: str, password_sign_up: str) -> None:
    """
    Saves the information of the new user in the _secret_auth.json file.
    """
    new_usr_data = {'username': username_sign_up, 'role': role1, 'name': name_sign_up, 'email': email_sign_up, 'phone': phone_sign_up, 'address': address_sign_up, 'gender':gender_sign_up, 'age': age_sign_up,  'password': ph.hash(password_sign_up)}
